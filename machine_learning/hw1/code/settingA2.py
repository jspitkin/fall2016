...
def main():
    ...
    decisionTree = dt.DecisionTree(2)
    decisionTree.constructTree(["SettingA/training.data"], possibleFeatureValuesFilePath)
    error = decisionTree.reportError(["SettingA/test.data"])
