...
public class Library {
	...
	public String lookup(long isbn) 
	{
		...
		for(LibraryBook lookIsbn : library)
	...
	public ArrayList<LibraryBook> lookup(String holder) 
	{
		...
		ArrayList<LibraryBook> holdersBook = new ArrayList<LibraryBook>();
		
		// look up the all book, and check holders are same, then add to holdersbook
		for(LibraryBook lookHolder : library)
			if(lookHolder.getHolder() == holder)
	...
	{
		// look all library books, and find isbn, if so set to check out with specific holder and day
		for(LibraryBook lookIsbn : library)
		{
	...
	{
		// look all library books, and check isbn, if so, set to check in
		for(LibraryBook lookIsbn : library)
		{
	...
	{
		int countBook = 0;
		// look all library book with holder, and set them all to check in
		for(LibraryBook lookHolder : library)
		{
			if(lookHolder.getHolder() == holder && lookHolder.getCheckIn() == false)
			{
