...
public class LibraryTest {
	...
	public static void main(String[] args) {
		...
		//More tests
		lib.add(9780446580345L, "Amir Joohnsen", "Testing Route");
		lib.add(9780446580346L, "James Franco", "Spider Man");
		lib.add(9780446580347L, "Will Dianei", "Test Two");
		lib.add(9780446580348L, "Clar Kent", "Superman");
		lib.add(9780446580349L, "Bruce Wayne", "Batman");
