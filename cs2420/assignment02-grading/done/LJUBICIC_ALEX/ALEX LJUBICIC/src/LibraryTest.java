...
public class LibraryTest {
	...
	public static void main(String[] args) {
		...
		// Lookup testing for Mushroom Publishing
		if (lib.lookup(9781843190516L) != null)
			System.err.println("TEST FAILED -- medium library: lookup(isbn)");
		if (lib.checkout(9781843190998L, "Alex L", 2, 3, 2016) == false) {
			System.err.println("TEST FAILED -- medium library: checkout");
		}

		// Checkout testing for Mushroom Publishing
		lib.checkout(9781843190011L, "Ben B", 3, 2, 2016);
		lib.checkout(9781843190677L, "Drew G", 5, 3, 2016);

		if (!(lib.checkout(9781843190011L, "Alex L", 4, 4, 2016) == false)) {
			System.err.println("TEST FAILED -- medium library: checkout2");
		}

		// Checkin testing for Mushroom Publishing
		if (lib.checkin("Ben B") == false) {
			System.err.println("TEST FAILED -- medium library: checkin(Holder)");
		}

		if (lib.checkin(9781843190677L) == false) {
