...
public class LibraryTest {
	...
	public static void main(String[] args) {
		...
		if (lib.lookup(9781843192022L) == null)
			System.err.println("TEST FAILED -- med library: lookup(isbn)");
		if (!lib.checkout(9781843192022L, "Jane Doe", 1, 1, 2008))
			System.err.println("TEST FAILED -- med library: checkout");
		booksCheckedOut = lib.lookup("Jane Doe");
		if (booksCheckedOut == null || booksCheckedOut.size() != 1
				|| !booksCheckedOut.get(0).equals(new Book(9781843192022L, "Roger Taylor", "Whistler"))
				|| !booksCheckedOut.get(0).getHolder().equals("Jane Doe")
				|| !booksCheckedOut.get(0).getDueDate().equals(new GregorianCalendar(2008, 1, 1)))
			System.err.println("TEST FAILED -- med library: lookup(holder)");
		if (!lib.checkin(9781843192022L))
			System.err.println("TEST FAILED -- med library: checkin(isbn)");
		if (lib.checkin("Jane Doe"))
			System.err.println("TEST FAILED -- med library: checkin(holder)");
