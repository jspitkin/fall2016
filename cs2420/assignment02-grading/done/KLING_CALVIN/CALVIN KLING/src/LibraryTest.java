...
public class LibraryTest {
	...
	public static void main(String[] args) {
		...
		if(lib.checkout(9781843192954L, "John Doe", -1, 10, 2016))
		...
		//Multiple holders checking books in and out
		lib.checkout(9781843190769L, "John Shepard", 7, 25, 2256);
		lib.checkout(9781843190998L, "Garrus Vakarian", 5, 16, 2256);
		lib.checkout(9781843192039L, "Thane Krios", 6, 2, 2256);
		lib.checkout(9781843190394L, "Mordin Solus", 4, 21, 2256);
		lib.checkout(9781843190400L, "Garrus Vakarian", 6, 5, 2256);
		lib.checkin(9781843192039L);
		lib.checkin(9781843190769L);
		lib.checkout(9781843190769L, "Garrus Vakarian", 8, 6, 2256);
		lib.checkin(9781843190998L);
		if(lib.lookup("Garrus Vakarian").size() != 2)
			System.err.println("TEST FAILED -- medium library: lookup(holder)");
		if(lib.lookup(9781843192039L) != null)
			System.err.println("TEST FAILED -- medium library: lookup(isbn) or checkout(isbn)"); 
