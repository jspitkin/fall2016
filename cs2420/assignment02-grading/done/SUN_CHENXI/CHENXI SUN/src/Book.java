...
public class Book {
	...
	public boolean equals(Object other) {
		...
		if(other instanceof Book){//do instance of so a casting of book can be done
			if((this.author==((Book) other).author)&&(this.isbn==((Book) other).isbn)&&(this.title==((Book) other).title)){//cast everything as book so equal method work for parent class as well
				return true;
			}
		}
