...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    if (!lib2.getInventoryList().get(0).equals(new Book(9780330351690L, "Jon Krakauer",
            "Into the Wild"))) System.err.println("TEST FAILED: getInventoryList");
    if (!lib2.getOrderedByAuthor().get(0).equals(new Book(9780446580342L, "David Baldacci", 
    		"Simple Genius"))) System.err.println("TEST FAILED: getOrderedByAuthor");
    
    PhoneNumber patron3 = new PhoneNumber("801.555.1234");

    if (!lib2.checkout(9780330351690L, patron3, 1, 1, 2008))
      System.err.println("TEST FAILED: first checkout");
    if (!lib2.checkout(9780374292799L, patron3, 1, 2, 2008))  
      System.err.println("TEST FAILED: second checkout");
    //getOverDueList should sort by oldest first, which should be Into the Wild
    if (!lib2.getOverdueList(1, 1, 2007).get(0).equals(new Book(9780330351690L, "Jon Krakauer", 
    		"Into the Wild")) || booksCheckedOut2.size() != 2) System.err.println("TEST FAILED: getOverDueList");
    if (!lib2.getOverdueList(1, 1, 2007).get(1).equals(new Book(9780374292799L, "Thomas L. Friedman", 
    		"The World is Flat"))) System.err.println("TEST FAILED: getOverDueList");
