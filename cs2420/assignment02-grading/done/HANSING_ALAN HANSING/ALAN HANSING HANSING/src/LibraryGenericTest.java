...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    lib1.checkout(9780330351690L, "Jon Krakauer", 1, 1, 2012);
    lib1.checkout(9780374292799L, null, 2, 2, 2011);
    ArrayList<LibraryBookGeneric<String>> toPrint = lib1.getOrderedByAuthor();
