...
public class PhoneNumber {
	...
	/**
	 * checks to make sure PhoneNumber is properly formatted and initializes it if it is
	 * @param phoneNum
	 */
	...
	/**
	 * checks equality between two PhoneNumbers
	 */
	...
	/**
	 * outputs string version of PhoneNumber
	 */
