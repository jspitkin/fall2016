...
public class LibraryTest {
	...
	public static void main(String[] args) {
		...
		if (!lib.checkout(9780330351690L, "Jane Doe Small", 1, 1, 2008))
			System.err.println("TEST FAILED -- small library: checkout");
		
		ArrayList<LibraryBook> booksCheckedOut2 = lib.lookup("Jane Doe Small");
		
		GregorianCalendar g1=new GregorianCalendar(2008,1,1);
		
		if (booksCheckedOut2 == null || booksCheckedOut2.size() != 1
				|| !booksCheckedOut2.get(0).equals(new Book(9780330351690L, "Jon Krakauer", "Into the Wild"))
				|| !booksCheckedOut2.get(0).getHolder().equals("Jane Doe Small")
				|| booksCheckedOut2.get(0).getDueDate().compareTo(g1)!=0)
			
			System.err.println("TEST FAILED -- small library: lookup(holder)small");
	
		if (!lib.checkin(9780330351690L))
			System.err.println("TEST FAILED -- small library: checkin(isbn)");
		if (lib.checkin("Jane Doe Small"))
		...
		if (!lib.checkout(9781843190004L, "Jane Doe Medium", 1, 1, 2008))
			System.err.println("TEST FAILED -- medium library: checkout");
		
		GregorianCalendar g2=new GregorianCalendar(2008,1,1);
		
		ArrayList<LibraryBook> booksCheckedOut3 = lib.lookup("Jane Doe Medium");
		if (booksCheckedOut3 == null || booksCheckedOut3.size() != 1
				|| !booksCheckedOut3.get(0).equals(new Book(9781843190004L, "Moyra Caldecott", "Weapons of the Wolfhound"))
				|| !booksCheckedOut3.get(0).getHolder().equals("Jane Doe Medium")
				|| booksCheckedOut3.get(0).getDueDate().compareTo(g2)!=0)
		...
		if (lib.checkin("Jane Doe Medium"))
