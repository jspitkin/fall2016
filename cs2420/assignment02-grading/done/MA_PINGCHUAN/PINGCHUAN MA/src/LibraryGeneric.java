...
public class LibraryGeneric<Type> {
	...
	public ArrayList<LibraryBookGeneric<Type>> lookup(Type holder) {
		...
		ArrayList<LibraryBookGeneric<Type>> bookstoaholder=new ArrayList<LibraryBookGeneric<Type>>();
		for(LibraryBookGeneric<Type> el: library){
			//???用equal还是==？？？？？？
			if(el.getHolder()!=null&&el.getHolder()==holder)
	...
	public boolean checkin(Type holder) {
	  ...
	  public ArrayList<LibraryBookGeneric<Type>> getOverdueList(int month, int day,
	    ...
	    // FILL IN -- do not return null
			ArrayList<LibraryBookGeneric<Type>> libraryCopy = new ArrayList<LibraryBookGeneric<Type>>();
			GregorianCalendar myGregorianCalendar=new GregorianCalendar(year, month, day);
			for(LibraryBookGeneric<Type> el:library){
				if(el.getDueDate()!=null&&el.getDueDate().compareTo(myGregorianCalendar)<0){
					libraryCopy.add(el);	
				}
	...
	Comparator<LibraryBookGeneric<Type>> {
		...
		public int compare(LibraryBookGeneric<Type> o1, LibraryBookGeneric<Type> o2) {
			...
			if(o1.getAuthor()!=o2.getAuthor())
				a=(int)(o1.getAuthor().compareTo(o2.getAuthor()));
			if(o1.getAuthor()==o2.getAuthor())
				a=(int)(o1.getTitle().compareTo(o2.getTitle()));
			return a;
		}
