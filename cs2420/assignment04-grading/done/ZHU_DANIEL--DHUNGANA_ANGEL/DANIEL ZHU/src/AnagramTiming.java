			...
			for(int exp = 10; exp <= 15; exp++) { // This is used as the exponent to calculate the size of the set.
				...
				for (int iter = 0; iter < ITER_COUNT; iter++) {
					...
					AnagramTester tester = new AnagramTester();
					 // This gets me a random int between 0 and size;
					
					String one = AnagramTester.randomString(size);
					String two = AnagramTester.randomString(size);
					// TIME IT!
					long start = System.nanoTime();
					util.areAnagrams(one, two);
