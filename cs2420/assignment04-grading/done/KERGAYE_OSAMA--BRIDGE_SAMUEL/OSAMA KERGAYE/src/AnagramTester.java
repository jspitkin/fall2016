...
public class AnagramTester {
	...
	public static void main(String[] args) 
	{
		...
		//String[] words = readFile("src\\assignment04\\sample_word_list.txt");
	...
	public static String randomString(int length)
	{
		...
		for(int i = 0; i < length; i++)
		{
			...
			char randomChar = (char)(rand.nextInt(26) + 'a');// This will throw a null pointer! Find the bug and squash it!
