...
public class SpellChecker {
	 ...
	 *                 - if the word is null
	 */
	public void addToDictionary(String word) throws NullPointerException {
		dictionary.add(word);
	}
	 ...
	 *                 - if the word is null
	 */
	public void removeFromDictionary(String word) throws NullPointerException {
	 ...
	 * 
	 * @param document_file
	 *                - the File that contains Strings to be looked up in
	 *                the dictionary
	...
	private List<String> readFromFile(File file) {
		...
		try (Scanner fileInput = new Scanner(file)) {
			/*
			 * Java's Scanner class is a simple lexer for Strings
			 * and primitive types (see the Java API, if you are
			 * unfamiliar).
			 */

			/*
			 * The scanner can be directed how to delimit (or
			 * divide) the input. By default, it uses whitespace as
			 * the delimiter. The following statement specifies
			 * anything other than alphabetic characters as a
			 * delimiter (so that punctuation and such will be
			 * ignored). The string argument is a regular expression
			 * that specifies "anything but an alphabetic
			 * character". You need not understand any of this for
			 * the assignment.
			 */
	...
	/**
	 * Returns whether or not the dictionary contains the given word.
	 * 
	 * @param word
	 *                - The word being searched for
	 * 
	 * @return - true if the word is in dictionary
	 */
