...
/**
 * This class tests the pathfinder class to ensure that each of the files can
 * be found and that writing to them is working and outputing properly.
 * 
...
public class TestPathFinder {
	...
	public static void main(String[] args) {
		...
		PathFinder.solveMaze("randomMaze.txt", "randomOutput.txt");
	}
}
