 ...
 *
 */
public class QuicksortMergesortTimingTest {
	...
	public static void main(String[] args) {
		...
		for(int testSize = 1024; testSize < CAP_SIZE; testSize *=2){
			...
			for(int iter = 0; iter < COUNT_TIMES; iter++){
				...
				quicksortList = SortUtil.generateAverageCase(testSize);
				mergesortList = new ArrayList<Integer>();
				for(int index = 0; index < quicksortList.size(); index++){
					mergesortList.add(quicksortList.get(index));
				}
