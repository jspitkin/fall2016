...
public class HuffmanTree {
  ...
  private void createTree() {
    ...
    while(pq.size() > 1){
    	Node currLeft = pq.poll();
    	Node currRight = pq.poll();
    	Node newAdd = new Node(currLeft, currRight);
    	currLeft.parent = newAdd;
    	currRight.parent = newAdd;
    	pq.add(newAdd);
    } 
    root = pq.poll();
  }
