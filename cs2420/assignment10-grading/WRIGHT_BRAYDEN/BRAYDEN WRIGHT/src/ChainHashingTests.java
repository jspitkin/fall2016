 ...
 */
public class ChainHashingTests {
    private int stringSetSize = 100;
    ...
    public void ChainAddTest() {
        ChainingHashTable table = new ChainingHashTable(stringSetSize / 10, new GoodHashFunctor());
    ...
    @Test
    public void ChainAddAllOneNewItemTest() {
        ChainingHashTable table = new ChainingHashTable(stringSetSize / 10, new GoodHashFunctor());
    ...
    @Test
    public void ChainContainsTest() {
        ChainingHashTable table = new ChainingHashTable(stringSetSize / 10, new GoodHashFunctor());
        String str = "Hello ChainingHashTable!";
        table.add(str);

        assertTrue(table.contains(str));
        assertFalse(table.contains("Hello QuadProbeHashTable!"));
    }

    @Test
    public void ChainContainsAllTest() {
        ChainingHashTable table = new ChainingHashTable(stringSetSize / 10, new GoodHashFunctor());
    ...
    @Test
    public void ChainContainsAllOneNewItemTest() {
        ChainingHashTable table = new ChainingHashTable(stringSetSize / 10, new GoodHashFunctor());
        table.addAll(stringList);
